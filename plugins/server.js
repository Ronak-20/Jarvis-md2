...
async (message, match) => {
    if (!match)
        return await message.sendPollMessage({ name: "Choose mode to change mode", values: [{ displayText: "private", id: "mode private"}, { displayText: "public", id: "mode public"}], withPrefix: true, participates: [message.sender] });
