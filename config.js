...
module.exports = {
  ...
  START_MSG : process.env.START_MSG || "*ᴊᴀʀᴠɪꜱ ɪꜱ ᴄᴏɴɴᴇᴄᴛᴇᴅ ⏎* \n\n *☇ ᴠᴇʀꜱɪᴏɴ :* ᴠ${require(__dirname + "/package.json").version}\n *☇ ᴩʟᴜɢɪɴꜱ :* ${cmds.commands.length}\n *☇ ᴍᴏᴅ :*  ${config.WORK_TYPE}\n *☇ ᴩʀᴇꜰɪx :*  ${config.HANDLERS}/n/n*ᴛʏᴩᴇ ᴀʟʟᴩʟᴜɢɪɴ ᴛᴏ ɢᴇᴛ ᴀʟʟ ᴩʟᴜɢɪɴ*",
